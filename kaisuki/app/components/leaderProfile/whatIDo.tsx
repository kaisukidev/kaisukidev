export function WhatIDo() {
  return (
    <div>
      <p><strong>Tech Lead:</strong> deep technical skills, leadership skills, ability to delegate tasks, communication and collaboration skills.
      ...
      <p><strong>Tech Coordinator:</strong> project management skills, leadership skills, communication skills, problem-solving ability.
      ...
      <p><strong>CTO:</strong> strategic skills, leadership skills, communication skills, critical thinking skills, and decision-making ability.
