export function WhatIDo() {
  return (
    <div>
      <p><strong className="text-sky-500">Tech Lead:</strong> deep technical skills, leadership skills, ability to delegate tasks, communication and collaboration skills.
